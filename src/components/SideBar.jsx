...
function SideBar() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      document
        .querySelector("html")
        .classList.remove("bg-light-mode-bg-very-light-gray");
      document
        .querySelector("html")
        .classList.add("dark", "bg-dark-mode-bg-very-dark-blue");
    } else {
      document
        .querySelector("html")
        .classList.remove("dark", "bg-dark-mode-bg-very-dark-blue");
      document
        .querySelector("html")
        .classList.add("bg-light-mode-bg-very-light-gray");
    }
  });
  return (
    <aside className="sider-bar">
  <div className="w-full flex justify-center">
  <div className="no flex justify-center">
      <SideList img={bolt} />
      </div>
  </div>
      <ul className="top-nav-list">
        ...
        <button className="mode relative bg-white">
          <div
            className={darkValue === "light" ? "bg-[#34CAA5] p-1 toggle" : ""}
            onClick={switchItLight}
          >
            <svg
          ...
          <div
            onClick={switchItDark}
            className={darkValue === "dark" ? "bg-[#D4D4D4] p-1 toggle" : ""}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
